...
const labels = {
  text: {
    de: "Dieser Bot ist ein Open-Source-Projekt von Stefan Peters (@stefandesu). Falls du an der Entwicklung interessiert ist, schau doch mal auf der [GitHub-Seite](https://github.com/stefandesu/goe-mensa-bot) vorbei.\n\nDer Bot wird durch Menüs gesteuert. Das Menü sollte sich beim Start des Bots schon geöffnet haben, aber es kann jederzeit wieder durch /menu geöffnet werden. For ein detailliertes How-To, besuche [diese Seite](https://github.com/stefandesu/goe-mensa-bot/blob/master/README.md#how-to-use) (nur Englisch).\n\nManchmal gibt es kurze Verzögerungen nach der Auswahl eines Menüpunkts, bitte nicht wundern. 😉",
